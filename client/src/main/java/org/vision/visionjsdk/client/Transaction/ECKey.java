...
public class ECKey implements Serializable, SignInterface {
  ...
  static {
    ...
    INSTANCE.put("MessageDigest.VISION-KECCAK-256", "vision-keccak-256");
    INSTANCE.put("MessageDigest.VISION-KECCAK-512", "vision-keccak-512");

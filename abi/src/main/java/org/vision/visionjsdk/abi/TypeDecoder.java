...
public class TypeDecoder {
    ...
    static Type instantiateArrayType(TypeReference ref, Object value)
        ...
        if (arraySize <= 0) {
            ...
            Class<?> arrayClass =
                    Class.forName("org.vision.visionjsdk.abi.datatypes.generated.StaticArray" + arraySize);
        ...
        try {
            Class<? extends StaticArray> arrayClass =
                    (Class<? extends StaticArray>)
                            Class.forName("org.vision.visionjsdk.abi.datatypes.generated.StaticArray" + length);
